...
namespace eval ttk::theme::arc {
    ...
    ttk::style theme create arc -parent default -settings {
        ttk::style configure . \
            ...
            -selectbackground $colors(-verylightgrey) \
        ...
        ttk::style configure TNotebook -tabmargins {0 0 0 0} -background $colors(-background)
        ttk::style configure TNotebook.Tab -padding {0 0 0 0} -expand {0 0 0}
        ttk::style map TNotebook.Tab -expand [list selected {0 0 0 0}]
        ttk::style configure TSeparator -background $colors(-bg)
        ttk::style configure Vertical.TScrollbar -background $colors(-background)
        ...
        ttk::style configure Treeview \
            ...
            -fieldbackground $colors(-altbackground) \
            -foreground $colors(-verylightgrey) \
            -padding {0 8 0 0}
        
        ttk::style map Treeview \
            -background [list selected $colors(-altbackground)]

        ttk::style configure Treeview.Item \
            -padding {8 0 0 0}

        ttk::style layout Treeview.Item {
            Treeite.padding -sticky news -children {
                Treeitem.indicator -side left 
                Treeitem.image -side left -children {
