...
python3 -m pip install numpy scipy scikit-image cloudpickle pillow PyInstaller ttkthemes pygame pyglm watchdog PyOpenGL PyOpenGL_accelerate >/dev/null 2>&1
